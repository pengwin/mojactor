...
mod local_actor_factory;
mod local_actor_trait;

mod virtual_actor_factory;
...
pub use local_actor_factory::{DefaultLocalActorFactory, LocalActorConstructor, LocalActorFactory};
...
pub use virtual_actor_factory::{
    DefaultVirtualActorFactory, VirtualActorConstructor, VirtualActorFactory,
};
